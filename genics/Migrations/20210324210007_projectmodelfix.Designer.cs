...
namespace genics.Migrations
{
    ...
    [Migration("20210324210007_projectmodelfix")]
    partial class projectmodelfix
    {
            ...
            modelBuilder.Entity("genics.Models.TaskModel", b =>
                {
                    ...
                    b.HasOne("genics.Models.Project", "Project")
                        .WithMany()
                        .HasForeignKey("ProjectId");

                    b.HasOne("genics.Models.ApplicationUser", "Reporter")
                        .WithMany()
